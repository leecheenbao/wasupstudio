...
//			mailSession.setDebug(true);
    ...
    public static void main(String[] args) {
        ...
        StringBuffer emailContent = mailContent_signUpV2(verificationCode);
        System.out.println(emailContent.toString());
    }


    public static StringBuffer mailContent_signUpV2(String verificationCode) {
        StringBuffer html = new StringBuffer();
        html.append(
